...
INSERT INTO "new_SimpleQuotation" ("bottleBoxCost", "createdAt", "customerName", "id", "note", "packageUnit", "productName", "productTypeId", "quotationNo", "setCount", "subMaterialCostPerUnit", "totalAmount", "totalMaterialCost", "updatedAt") SELECT "bottleBoxCost", "createdAt", "customerName", "id", "note", "packageUnit", "productName", "productTypeId", "quotationNo", "setCount", "subMaterialCostPerUnit", "totalAmount", "totalMaterialCost", "updatedAt" FROM "SimpleQuotation";
