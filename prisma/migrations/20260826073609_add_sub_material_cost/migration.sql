...
INSERT INTO "new_SimpleQuotation" ("bottleBoxCost", "createdAt", "customerName", "id", "note", "packageUnit", "productName", "productTypeId", "quotationNo", "setCount", "totalAmount", "totalMaterialCost", "updatedAt") SELECT "bottleBoxCost", "createdAt", "customerName", "id", "note", "packageUnit", "productName", "productTypeId", "quotationNo", "setCount", "totalAmount", "totalMaterialCost", "updatedAt" FROM "SimpleQuotation";
